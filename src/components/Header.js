...
import img from '../img/IMG_6370 copy.jpg'
    ...
    return(
        ...
        <div class="d-flex flex-column">
          ...
          <div class="profile">
            ...
            <img class='imga'src={img} alt="Img"/>
          ...
          <nav id="navbar" class="nav-menu navbar">
            <ul>
              <li>
                <a href="#hero" class="nav-link scrollto active"><i class="bx bx-home"></i> <span>Home</span></a></li>
